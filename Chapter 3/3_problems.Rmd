...
**Age Percentile US: `r age_us_percentile`**
...
age_region <- subset(df_region, df_region$Region == sample_region)
age_region_less <- age_region$ID[age_region$Age < sample_age]
age_region_percentile <- length(age_region_less)/length(age_region$ID)

```

**Age Percentile Region:`r age_region_percentile`**
...
age_state <- subset(df_region, df_region$State == sample_state)
age_state_less <- age_state$ID[age_state$Age < sample_age]
age_state_percentile <- length(age_state_less)/length(age_state$ID)

```

**Age Percentile State: `r age_state_percentile`**
